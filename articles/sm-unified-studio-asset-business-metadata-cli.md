...
emoji: "🏷️"
type: "tech"
topics: ["AWS", "SageMakerUnifiedStudio", "DataZone", "DataCatalog", "AWSCLI"]
published: true
---
...
- アセットが既に作成済みであること（[アセット作成手順](https://zenn.dev/atsutoishinaga/articles/sagemaker-unified-studio-create-asset-from-glue)を参照）
