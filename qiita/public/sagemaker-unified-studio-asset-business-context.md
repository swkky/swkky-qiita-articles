...
tags:
  ...
  - DataAgent
  - DataCatalog
updated_at: '2026-08-24T05:45:55.729Z'
id: null
...
:::note alert
繰り返しですが、AWS は各フィールドの重みを公開していません。以下は公式ドキュメントの記述の強さ・具体性と、実務上の整備コストを考慮した**筆者個人の判断**です。
:::
...
- テクニカル名が自明（`customer_id` 等）なら不要
- 名前から意味を汲み取れない場合は必ず設定
